...
namespace DrinkAge_1._0
{
    public partial class FrmSearch_Fang : Form
    {
        public FrmSearch_Fang()
        {
            ...
            this.dataGrid_List.ColumnHeadersDefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            this.dataGrid_List.RowsDefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
        }
        ...
        private void cboCategoryDetail_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cboCategory != null && cboCategoryDetail !=null)
            {
                ...
                try
                {
                    ...
                    dataAdapter.Fill(ds);
                    this.dataGrid_List.DataSource = ds.Tables[0];
                }
                catch (Exception ex)
                {
                    MessageBox.Show(ex.Message, "SystemError!!");
        ...
        private void btnComment_Click(object sender, EventArgs e)
        {
            DrinkAgeEntities dbContext = new DrinkAgeEntities();
                ...
                this.dataGrid_List.DataSource = Q2.ToList();
